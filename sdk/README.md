# Rust API client for spacetraders-sdk
...
Put the package under your project folder in a directory named `spacetraders-sdk` and add the following to `Cargo.toml` under `[dependencies]`:

```
spacetraders-sdk = { path = "./spacetraders-sdk" }
```
